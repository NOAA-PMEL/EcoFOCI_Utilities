...
def EPIC2Datetime(timeword_1, timeword_2):
    ...
    A misprintexists that specifies a reference date of 1968-05-23 as 2400000 when it should be 2440000
    
    http://aa.usno.navy.mil/data/docs/JulianDate.php

    Converts the "true julian date" and confirms the misprintin the documentation.
    ...
    epic_dt = [
        ref_time_dt + datetime.timedelta(days=int(a), seconds=c)
